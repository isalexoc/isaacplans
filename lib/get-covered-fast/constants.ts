...
/**
 * Hero art on the public `/final-expense/apply` marketing page (16:9 media slot,
 * `object-cover`). Reuses the get-covered funnel's existing EN hero photo as a placeholder —

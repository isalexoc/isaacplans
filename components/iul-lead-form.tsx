...
export default function IulLeadForm({ onSubmitSuccess, onCloseModal }: Props) {
  const locale = useLocale();
  const isES = locale.startsWith("es");
  const t = useTranslations("iulPage.leadForm");
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              href={
                ...
                formValues.email ||
                formValues.phone
                  ? `/iul/calendar?${new URLSearchParams({
                      first_name: formValues.firstName,
                      last_name: formValues.lastName,
                      email: formValues.email,
                      phone: formValues.phone,
                    }).toString()}`
                  : "/iul/calendar") as "/iul/calendar"
              }
  ...
  return (
    <form id="iul-lead-form" action={formAction} className="space-y-4">

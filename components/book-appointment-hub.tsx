...
export default function BookAppointmentHub() {
  ...
  return (
    <div className="relative w-full overflow-hidden">
      <div
        className="pointer-events-none absolute inset-0 bg-gradient-to-b from-[hsl(var(--custom)/0.08)] via-transparent to-transparent"
        aria-hidden
      />
      <div className="relative mx-auto max-w-5xl px-4 pb-16 pt-8 sm:px-6 lg:px-8">
        <header className="mx-auto mb-10 max-w-2xl text-center">
          ...
          <p className="mt-3 text-base text-gray-600 sm:text-lg">{t("hero.subtitle")}</p>
                ...
                >
                  <Card
                    className={cn(
                      ...
                      "group-hover:border-[hsl(var(--custom)/0.35)] group-hover:shadow-md",
                      isGeneral && "ring-1 ring-[hsl(var(--custom)/0.2)]"
                    )}
                  >
                    <CardHeader className="flex flex-row items-start gap-4 space-y-0 pb-2">
                      <span
                        className="flex h-11 w-11 shrink-0 items-center justify-center rounded-lg bg-[hsl(var(--custom)/0.12)] text-[hsl(var(--custom))] transition-transform duration-200 group-hover:scale-105"
                        aria-hidden
                      >
                        <Icon className="h-5 w-5" aria-hidden />
                      </span>
                      <div className="min-w-0 flex-1 space-y-1.5">
                        <CardTitle className="text-lg leading-snug text-gray-900 group-hover:text-[hsl(var(--custom))]">
                          {t(`options.${key}.title`)}
                        </CardTitle>
                      ...
                      <Lucide.ArrowRight
                        className="mt-1 h-5 w-5 shrink-0 text-gray-400 transition-transform duration-200 group-hover:translate-x-0.5 group-hover:text-[hsl(var(--custom))]"
                        aria-hidden
                      />
                    </CardHeader>
                  </Card>
        ...
        <p className="mx-auto mt-10 max-w-xl text-center text-sm text-gray-500">{t("footnote")}</p>
      </div>
    </div>
  );
}

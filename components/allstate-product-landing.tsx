...
const ALLSTATE_LOGO =
  "https://res.cloudinary.com/isaacdev/image/upload/f_auto,q_auto,w_200/v1774397414/allstate_logo_ungrkt.png";

const gradientBtn =
  "inline-flex min-h-[48px] w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#0033A0] to-[#0077B6] px-5 py-3 text-sm font-semibold text-white shadow-[0_12px_40px_-16px_rgba(0,51,160,0.45)] transition hover:brightness-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#0033A0] focus-visible:ring-offset-2 sm:text-base";

export type AllstateProductLandingProps = {
  t: Awaited<ReturnType<typeof getTranslations>>;
  quoteUrl: string;
  /** e.g. `seniors.all-products.` or `cancerOnly.` */
  translationKeyPrefix: string;
  heroSrc: string;
};

export default function AllstateProductLanding({
  t,
  quoteUrl,
  translationKeyPrefix: prefix,
  heroSrc,
}: AllstateProductLandingProps) {
  ...
  return (
    <main id="allstate-product-main" className="text-foreground">
      <section
        ...
        aria-labelledby="allstate-product-hero-heading"
      >
        <div
        ...
        <div className="relative mx-auto max-w-6xl px-4 pb-12 pt-20 sm:px-6 sm:pb-16 sm:pt-16 lg:px-8 lg:pb-20 lg:pt-20">
          <div className="grid gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,1fr)] lg:items-center lg:gap-12">
            <div className="order-2 min-w-0 lg:order-1">
              ...
              <span className="inline-flex w-fit items-center gap-2 rounded-full border border-[#0033A0]/25 bg-background/90 px-4 py-1.5 text-xs font-semibold tracking-wide text-[#0033A0] shadow-sm backdrop-blur-sm dark:text-[#5eb3e8]">
                <Shield className="h-3.5 w-3.5 shrink-0" aria-hidden />
                {t(`${prefix}hero.badge`)}
              </span>
              <h1
                id="allstate-product-hero-heading"
            ...
            <figure className="relative order-1 aspect-[4/3] w-full min-w-0 overflow-hidden rounded-2xl shadow-[0_25px_50px_-12px_rgba(15,23,42,0.25)] ring-1 ring-black/10 dark:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.45)] dark:ring-white/10 lg:order-2">
              ...
              />
              <div
                className="pointer-events-none absolute inset-0 bg-gradient-to-br from-[#0033A0]/[0.12] via-transparent to-transparent"
                aria-hidden
              />
            </figure>
          </div>
      ...
      <section
        ...
        aria-labelledby="allstate-product-sections-heading"
      >
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <h2 id="allstate-product-sections-heading" className="sr-only">
      ...
      <section
        ...
        aria-labelledby="allstate-product-more-heading"
      >
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <h2
            id="allstate-product-more-heading"
      ...
      <section
        className="border-b border-border/60 py-14 sm:py-16 lg:py-20"
        aria-labelledby="allstate-product-highlights-heading"
      >
        <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
          <div className="mb-8 flex items-center gap-2 text-[#0033A0] dark:text-[#5eb3e8]">
            <Sparkles className="h-6 w-6 shrink-0" aria-hidden />
            <h2
              id="allstate-product-highlights-heading"
          ...
          <ul className="grid gap-4 sm:grid-cols-1 md:grid-cols-3">
            {highlights.items.map((text, i) => (
              ...
              >
                <CheckCircle2
                  className="mt-0.5 h-5 w-5 shrink-0 text-[#0033A0] dark:text-[#5eb3e8]"
                  aria-hidden
                />
      ...
      <section
        ...
        aria-labelledby="allstate-product-quote-cta-heading"
      >
        <div className="mx-auto max-w-lg px-4 sm:px-6 lg:px-8">
          <div className="rounded-2xl border border-border/80 bg-gradient-to-br from-[#0033A0]/[0.06] to-background p-6 shadow-sm ring-1 ring-black/5 sm:p-8">
            <h2
              id="allstate-product-quote-cta-heading"
      ...
      <UhoneProductFaq
        ...
        items={faqItems}
        sectionId="allstate-product-faq-heading"
      />

      <section
        className="border-b border-border/60 bg-gradient-to-br from-[#0033A0]/[0.06] to-background py-14 sm:py-16"
        aria-labelledby="allstate-product-contact-heading"
      >
        <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
          <h2 id="allstate-product-contact-heading" className="text-2xl font-bold tracking-tight">

/* components/form-modal-aca.tsx — ACA quote via Agent CRM private integration */
"use client";
...
interface AcaQuoteModalProps {
  open: boolean;
  setOpen: (v: boolean) => void;
}

export const AcaQuoteModal = ({ open, setOpen }: AcaQuoteModalProps) => {
            ...
            <div className="flex flex-col sm:flex-row min-h-0">
              ...
              <div className="flex-1 min-w-0 px-4 sm:px-6 py-6">
                <div className="max-w-[400px] mx-auto">
                  <AcaLeadForm onCloseModal={() => setOpen(false)} />
                </div>
              </div>
            </div>
          </div>

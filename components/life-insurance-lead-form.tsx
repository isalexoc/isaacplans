...
import {
  submitLifeInsuranceForm,
  type ActionResult,
  type FormValues,
} from "@/app/actions/life-insurance";
import PhoneInput, { parsePhoneNumber } from "react-phone-number-input";
import "react-phone-number-input/style.css";
import { Link } from "@/i18n/navigation";
import LifeInsuranceSelfEnrollCta from "@/components/life-insurance-self-enroll-cta";
...
export default function LifeInsuranceLeadForm({ onSubmitSuccess, onCloseModal }: Props) {
  const locale = useLocale();
  const isES = locale.startsWith("es");
  const t = useTranslations("lifeInsurancePage.leadForm");
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              href={
                ...
                formValues.email ||
                formValues.phone
                  ? `/life-insurance/calendar?${new URLSearchParams({
                      first_name: formValues.firstName,
                      last_name: formValues.lastName,
                      email: formValues.email,
                      phone: formValues.phone,
                    }).toString()}`
                  : "/life-insurance/calendar") as "/life-insurance/calendar"
              }
  ...
  return (
    <form id="life-insurance-lead-form" action={formAction} className="space-y-4">
      ...
      <div>
        <label
          htmlFor="life-insurance-cta-firstName"
        ...
        <input
          type="text"
          id="life-insurance-cta-firstName"
          name="firstName"
      ...
      <div>
        <label
          htmlFor="life-insurance-cta-lastName"
          className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5"
        >
        ...
        <input
          type="text"
          id="life-insurance-cta-lastName"
          name="lastName"
      ...
      <div>
        <label
          htmlFor="life-insurance-cta-email"
          className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5"
        >
      ...
      <div>
        <label
          htmlFor="life-insurance-cta-phone"
          className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5"
        >
          {t("phone")} <span className="text-red-500">*</span>
        </label>
        <PhoneInput
          id="life-insurance-cta-phone"
          name="phone"
          defaultCountry="US"
          countries={["US"]}

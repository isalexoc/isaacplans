...
type SaleStickerLandingShareProps = {
  className?: string;
};

export function SaleStickerLandingShare({ className }: SaleStickerLandingShareProps) {
  ...
  return (
    <button
      ...
      className={cn(
        ...
        "hover:border-amber-400/40 hover:bg-amber-500/15 hover:text-amber-50",
        "focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-400/60 focus-visible:ring-offset-2 focus-visible:ring-offset-[#060a12]",

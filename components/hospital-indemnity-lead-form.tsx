...
import {
  submitHospitalIndemnityForm,
  type ActionResult,
  type FormValues,
} from "@/app/actions/hospital-indemnity";
...
export default function HospitalIndemnityLeadForm({
  ...
  const t = useTranslations("HIpage.leadForm");
  ...
  if (state.status === "SUCCESS") {
    return (
      <div className="py-4 text-center">
        <div className="rounded-xl bg-gradient-to-br from-violet-50 to-slate-50 dark:from-violet-900/30 dark:to-slate-900/20 border-2 border-violet-200 dark:border-violet-800 p-6 shadow-sm">
          <div className="w-14 h-14 mx-auto mb-4 rounded-full bg-violet-500/20 dark:bg-violet-500/30 flex items-center justify-center">
            <svg
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              href={
                ...
                formValues.email ||
                formValues.phone
                  ? `/hospital-indemnity/calendar?${new URLSearchParams({
                      first_name: formValues.firstName,
                      last_name: formValues.lastName,
                      email: formValues.email,
                      phone: formValues.phone,
                    }).toString()}`
                  : "/hospital-indemnity/calendar") as "/hospital-indemnity/calendar"
              }
  ...
  return (
    <form
      id="hospital-indemnity-lead-form"
      action={formAction}
      className="space-y-4"
    >
      ...
      <button
        type="submit"
        disabled={isPending}
        className="w-full bg-gradient-to-r from-violet-600 to-slate-700 hover:from-violet-700 hover:to-slate-800 text-white font-semibold py-3.5 px-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
      >

          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              href={
                ...
                formValues.email ||
                formValues.phone
                  ? `/aca/calendar?${new URLSearchParams({
                      first_name: formValues.firstName,
                      last_name: formValues.lastName,
                      email: formValues.email,
                      phone: formValues.phone,
                    }).toString()}`
                  : "/aca/calendar") as "/aca/calendar"
              }
  ...
  return (
    <form id="aca-lead-form" action={formAction} className="space-y-4">
      ...
      <button
        type="submit"
        disabled={isPending}
        className="w-full bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-600 hover:to-blue-700 text-white font-semibold py-3.5 px-6 rounded-lg shadow-lg hover:shadow-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
      >

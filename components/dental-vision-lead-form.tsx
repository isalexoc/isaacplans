...
import {
  submitDentalVisionForm,
  type ActionResult,
  type FormValues,
} from "@/app/actions/dental-vision";
...
type Props = {
  ...
  onCloseModal?: () => void;
  /** Passed to create-contact as dentalVisionData.source */
  source?: string;
};

export default function DentalVisionLeadForm({
  onSubmitSuccess,
  onCloseModal,
  ...
  const t = useTranslations("dentalVisionPage.leadForm");
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              href={
                ...
                formValues.email ||
                formValues.phone
                  ? `/dental-vision/calendar?${new URLSearchParams({
                      first_name: formValues.firstName,
                      last_name: formValues.lastName,
                      email: formValues.email,
                      phone: formValues.phone,
                    }).toString()}`
                  : "/dental-vision/calendar") as "/dental-vision/calendar"
              }
  ...
  return (
    <form id="dental-vision-lead-form" action={formAction} className="space-y-4">

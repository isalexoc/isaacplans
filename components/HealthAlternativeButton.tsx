...
import { HealthAlternativeQuoteModal } from "@/components/form-modal-health-alternative";
import { useTranslations } from "next-intl";

export default function HealthAlternativeButton() {
  const [openModal, setOpenModal] = useState(false);
  const t = useTranslations("healthAlternativePage.ctaButton");
  ...
  return (
    ...
    >
      ...
      >
        ...
        <HealthAlternativeQuoteModal open={openModal} setOpen={setOpenModal} />
      </motion.div>
    </motion.div>
  );
}

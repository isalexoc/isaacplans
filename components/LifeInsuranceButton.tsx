...
import { LifeInsuranceQuoteModal } from "@/components/form-modal-life-insurance";
import { useTranslations } from "next-intl";

export default function LifeInsuranceButton() {
  const [openModal, setOpenModal] = useState(false);
  const t = useTranslations("lifeInsurancePage.ctaButton");
  ...
  return (
    ...
    >
      ...
      >
        ...
        <LifeInsuranceQuoteModal open={openModal} setOpen={setOpenModal} />
      </motion.div>
    </motion.div>
  );
}

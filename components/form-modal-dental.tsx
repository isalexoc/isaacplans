/* components/form-modal-dental.tsx — Dental & Vision quote via Agent CRM private integration */
"use client";
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      >
        <div className="flex flex-col min-h-0 flex-1 w-full rounded-xl bg-background shadow-2xl overflow-hidden">
          <div className="flex-shrink-0 z-10 flex items-center justify-between gap-3 px-4 py-3 bg-gradient-to-r from-blue-600/12 to-indigo-600/10 dark:from-blue-900/30 dark:to-indigo-900/20 border-b border-blue-200/40 dark:border-blue-800/50">
                ...
                <div className="flex-1 sm:flex-none sm:w-full sm:text-center">
                  ...
                  <div className="mt-2 flex flex-wrap gap-x-3 gap-y-0.5 sm:flex-col sm:gap-y-2 sm:mt-4 sm:items-center">
                    ...
                    <div className="flex items-center gap-1 text-xs text-gray-600 dark:text-gray-400">
                      ...
                      <span>{isES ? "2,500+ clientes" : "2,500+ members"}</span>
                    </div>
                  </div>
                </div>
              </div>

    ...
    <div className="my-8 pt-8 border-t border-gray-200 dark:border-gray-700">
      <div className="max-w-md mx-auto text-center">
        ...
        {message && status === "error" && (
          <div className="mt-3 flex items-start gap-2 p-3 rounded-lg text-sm bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-red-800 dark:text-red-200">

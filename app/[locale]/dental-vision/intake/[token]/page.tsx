/*
 * app/[locale]/dental-vision/intake/[token]/page.tsx — the client-facing Dental & Vision application.
 *
...
const COPY: Record<SupportedLocale, { title: string; description: string }> = {
  en: {
    title: "Your Secure Dental & Vision Application | Isaac Plans Insurance",
    description: "Complete your dental and vision application securely from your phone. Your progress saves automatically.",
  },
  es: {
    title: "Su Solicitud Segura Dental y de Visión | Isaac Plans Insurance",
    description: "Complete su solicitud dental y de visión de forma segura desde su teléfono. Su progreso se guarda automáticamente.",
  },
};
...
export default async function DentalVisionIntakeFormPage({
  params,
}: {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-950">
      <IntakeForm lob="dental-vision" token={token} />
    </main>
  );
}

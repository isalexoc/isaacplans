/* app/[locale]/iul/application/page.tsx – server component */
...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const routeKey = "/iul/application";
...
/* ───────── Page ───────── */
export default async function IULApplicationPage() {
  const locale = (await getLocale()) as SupportedLocale;
  const t = await getTranslations({ locale, namespace: "iulApplication" });

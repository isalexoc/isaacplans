...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const image = t("image", {
    default: "https://www.isaacplans.com/images/faq.png",
  }) as string;
  const alt = t("imageAlt", { default: "Frequently Asked Questions" });
    ...
    <main className="w-full flex flex-col overflow-x-hidden">
      ...
      {categories.map((category, index) => {
        const faqs = Array.from({ length: 12 }, (_, i) => ({
          question: t(`categories.${category.key}.questions.${i}.question`),
          answer: t(`categories.${category.key}.questions.${i}.answer`),
        }));

/*
 * app/[locale]/hospital-indemnity/intake/[token]/page.tsx — the client-facing Hospital Indemnity application.
 *
...
const COPY: Record<SupportedLocale, { title: string; description: string }> = {
  en: {
    title: "Your Secure Hospital Indemnity Application | Isaac Plans Insurance",
    description: "Complete your hospital indemnity application securely from your phone. Your progress saves automatically.",
  },
  es: {
    title: "Su Solicitud Segura de Indemnización Hospitalaria | Isaac Plans Insurance",
    description: "Complete su solicitud de indemnización hospitalaria de forma segura desde su teléfono. Su progreso se guarda automáticamente.",
  },
};
...
export default async function HospitalIndemnityIntakeFormPage({
  params,
}: {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-950">
      <IntakeForm lob="hospital-indemnity" token={token} />
    </main>
  );
}

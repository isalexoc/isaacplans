/*
 * app/[locale]/short-term-medical/intake/[token]/page.tsx — the client-facing Short Term Medical application.
 *
...
const COPY: Record<SupportedLocale, { title: string; description: string }> = {
  en: {
    title: "Your Secure Short Term Medical Application | Isaac Plans Insurance",
    description: "Complete your short term medical application securely from your phone. Your progress saves automatically.",
  },
  es: {
    title: "Su Solicitud Segura de Cobertura a Corto Plazo | Isaac Plans Insurance",
    description: "Complete su solicitud de cobertura a corto plazo de forma segura desde su teléfono. Su progreso se guarda automáticamente.",
  },
};
...
export default async function ShortTermMedicalIntakeFormPage({
  params,
}: {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-gray-950 dark:to-gray-950">
      <IntakeForm lob="short-term-medical" token={token} />
    </main>
  );
}
